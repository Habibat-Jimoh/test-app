...
seo_templates = {
    ...
    "map": {
        ...
        "allow-same-origin allow-forms allow-scripts allow-downloads allow-popups allow-popups-to-escape-sandbox allow-top-navigation-by-user-activation",
        "SEO-figcaption":
        "Interactive map chart displaying the {year} {country} presidential election results, illustrating how each party and/or candidate performed by region based on the number of votes received across different areas.",
        "SEO-description":
